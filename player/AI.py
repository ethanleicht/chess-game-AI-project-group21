...
class AI:
    ...
    def calculateb(self, gametiles):
        ...
        total_evaluation = material_value + positional_value + center_control_value + tactical_value + endgame_value + pawn_structure_score + opening_bonus + development_value + king_safety_value
